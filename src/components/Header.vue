    ...
    <div class="header-inner">
      <div class="header-brand" @click="$router.push('/')">
        ...
        <div>
          ...
          <div class="brandname-sub">Making Higher Education Open to All</div>
        </div>
      </div>
      <nav>
        <div class="menus">
          <router-link class="menu-item" to="/ujian-lobby/pjluo"><img src="../assets/petugas.svg" alt=""><span>PETUGAS</span></router-link>
